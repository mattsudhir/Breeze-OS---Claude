...
Combined-dimension maintenance (when a single metric_key doesn't fit):
- Use count_maintenance for questions that cross two dimensions, e.g. "urgent HVAC", "stale plumbing", "open tickets mentioning mold". It hits the local mirror in ~100ms.
- Single-dimension questions ("how many open work orders", "how many urgent") should still go through get_chat_metric (it's slightly faster and pre-warmed).

...
//   ZOHO_CLIQ_WEBHOOK_URL – the full, self-authenticating outbound URL
//     for the target Cliq bot or channel. Whatever shape Cliq gave you
//     should be pasted here verbatim — most commonly one of:
//       https://cliq.zoho.com/api/v2/bots/<botname>/incoming?zapikey=xxx
//       https://cliq.zoho.com/api/v2/channelsbyname/<name>/message?zapikey=xxx
//     The helper does NOT try to inject authentication on your behalf —
//     if the URL fails auth, the fix is to paste a different URL, not
//     to tweak this file.
//

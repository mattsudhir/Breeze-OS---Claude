...
//                           admin panel. Example:
//                             https://<tenant>.zohomcp.com/mcp/message?key=<k>
//                           The `?key=` segment is a tenant identifier,
//                           NOT a credential. The URL alone is not
//                           enough to authenticate — Zoho requires
//                           OAuth 2.1 per request (see below).
//
...
//   1. On your laptop, `npx mcp-remote https://<tenant>.zohomcp.com/mcp/message?key=<k>`

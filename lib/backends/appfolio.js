...
//
// AppFolio's API endpoints actually live under the customer's own
// subdomain (https://<customer>.appfolio.com/...) for both the
// Database API v0 and the Reports API v1/v2 — not the shared
// api.appfolio.com host their docs sometimes show. We default to
// Breeze Property Group's subdomain; override with APPFOLIO_SUBDOMAIN
// when migrating to a different customer account, or override the
// full Database API URL with APPFOLIO_DATABASE_API_URL.
...
const BASE_URL =
  ...
  `https://${APPFOLIO_SUBDOMAIN}.appfolio.com/api/v0`;

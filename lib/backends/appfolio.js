...
export async function probeReportsEndpoints() {
  ...
  const variants = [
    {
      label: 'subdomain v1 reports POST .json (current default)',
      url: `https://${subdomain}.appfolio.com/api/v1/reports/chart_of_accounts.json`,
      method: 'POST',
      body: {},
    },
    {
      label: 'subdomain v1 reports GET .json',
      url: `https://${subdomain}.appfolio.com/api/v1/reports/chart_of_accounts.json`,
      method: 'GET',
    },
    {
    ...
    {
      label: 'shared api host v1 reports POST .json',
      url: `https://api.appfolio.com/api/v1/reports/chart_of_accounts.json`,
      method: 'POST',
      body: {},
    },
    {
      label: 'subdomain v0 properties GET (does subdomain host any API?)',
      url: `https://${subdomain}.appfolio.com/api/v0/properties?filters%5BLastUpdatedAtFrom%5D=1970-01-01T00:00:00Z&page%5Bsize%5D=1`,
      method: 'GET',
    },
    {
      label: 'subdomain reports POST (no version, no .json)',
      url: `https://${subdomain}.appfolio.com/api/reports/chart_of_accounts`,
      method: 'POST',
      body: {},
    },
    {
      label: 'subdomain root GET (what does the server identify as?)',
      url: `https://${subdomain}.appfolio.com/`,
      method: 'GET',
    },
  ];

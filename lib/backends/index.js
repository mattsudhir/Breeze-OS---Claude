...
//   }
//
// getTools() is async to support dynamic tool discovery (Zoho MCP
// queries the remote server for its tool list on first call).
...
export const DEFAULT_BACKEND = 'breeze';

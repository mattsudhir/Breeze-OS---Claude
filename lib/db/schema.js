...
// pair. The token is the platform-specific identifier FCM hands back
// after registration — for iOS this is an APNs token Firebase has
// already exchanged, for Android it's a raw FCM token. We never store
// the user's APNs token directly; FCM gives us one unified send API.
...
export const deviceTokens = pgTable(
  ...
  (t) => ({
    orgIdx: index('device_tokens_org_idx').on(t.organizationId),

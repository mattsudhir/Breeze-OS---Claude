...
// Count rentable units = Breeze units (the deduped authoritative
// directory) MINUS any whose AppFolio mirror row has NonRevenue=true.
// schema.units doesn't carry the non-revenue flag itself, so we join
// to appfolio_cache on source_unit_id and exclude flagged rows.
// Unmapped Breeze units (no mirror row) stay included.

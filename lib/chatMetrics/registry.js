...
export const METRICS = {
  ...
  urgent_maint_count: {
    ...
    scopeType: 'org',
    description:
      'Count of OPEN urgent / emergency-priority work orders.',
    dependsOn: ['work_orders'],
    ttlSeconds: 5 * 60,
  ...
  delinquent_tenant_count: {
    ...
    scopeType: 'org',
    description:
      'Count of tenants whose current balance is > 0 (owes money).',
  ...
  total_delinquency_cents: {
    ...
    scopeType: 'org',
    description:
      'Sum of positive tenant balances across the portfolio, in cents.',
    dependsOn: ['tenants', 'charges'],
    ttlSeconds: 15 * 60,

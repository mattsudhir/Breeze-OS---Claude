...
export const TASK_TYPES = {
  ...
  confirm_rent_received: {
    label: 'Confirm rent received',
    slaHours: 48,
    description:
      'A rent payment is expected or has been recorded. Confirm the ' +
      'deposit landed in the operating account and that the receipt is ' +
      'posted against the right charge in AppFolio.',
    actionLabel: 'Open tenant in AppFolio',
  },
  renew_lease: {
    label: 'Renew lease',
    slaHours: 720, // 30 days — the standard renewal-conversation window
    description:
      'A lease is approaching its end date. Reach out to the tenant, ' +
      'negotiate the renewal terms, and either generate the renewal in ' +
      'AppFolio or start the move-out / re-list workflow.',
    actionLabel: 'Open lease in AppFolio',
  },
  // Future: review_maintenance_request, follow_up_vendor,
  // respond_tenant_message, etc.
};

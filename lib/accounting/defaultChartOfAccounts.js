...
export const DEFAULT_CHART_OF_ACCOUNTS = [
  ...
  // Intercompany. One asset / one liability — every multi-entity org
  // posts both legs of every intercompany transaction (debit IC AR on
  // the lender entity, credit IC AP on the borrower entity) so the
  // consolidating elimination is just `code IN ('1450', '2050')`.
  { code: '1450', name: 'Intercompany Receivable', accountType: 'asset', accountSubtype: 'receivable_other', normalBalance: 'debit', isSystem: true,
    notes: 'Amounts owed by another entity in the same org. Tag the lender as entity_id and the borrower as counterparty_entity_id. Eliminated on consolidation.' },
  ...
  // Intercompany payable — counterpart of 1450 Intercompany Receivable.
  { code: '2050', name: 'Intercompany Payable', accountType: 'liability', accountSubtype: 'accounts_payable', normalBalance: 'credit', isSystem: true,
    notes: 'Amounts owed to another entity in the same org. Tag the borrower as entity_id and the lender as counterparty_entity_id. Eliminated on consolidation.' },
